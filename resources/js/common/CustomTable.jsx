...
export default function CustomTable(props) {
    ...
    const table = useMaterialReactTable({
        ...
        renderRowActionMenuItems: ({ closeMenu , row}) => actions(closeMenu,row),
    });
    ...
    const actions = (closeMenu,row) => [
        ...
        <>
            ...
            <li>
                <button className="text-danger hover:text-danger flex space-x-2"
                        onClick={() => handleDelete(row.original.id, closeMenu)}>
                    <svg
                        className="fill-current"
                        width="16"
                        height="16"
