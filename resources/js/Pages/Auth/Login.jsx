                    ...
                    <div className=" w-full lg:block lg:w-1/2">
                        <div className="text-center">
                            <div className="w-full p-4 sm:p-12.5 xl:p-17.5">
                                <span className="Uncaught Error: Objects are not valid as a React child (found: object with keys {children}). If you meant to render a collection of children, use an array instead.mb-1.5 block font-medium">
                                    Start for free
                                </span>
                                ...
                                <form onSubmit={handleSubmit(onSubmit)}>
                                    <div className="mb-4">
                                        <InputLabel className="mb-2.5 block font-medium text-black dark:text-white" value="Email"/>
                                    ...
                                    <div className="mb-6">
                                        <InputLabel className="mb-2.5 block font-medium text-black dark:text-white" value="Type Password"/>
                                        <div className="relative">
                                            <TextInput
                                                className="w-full rounded-lg border border-stroke bg-transparent py-4 pl-6 pr-10 text-black outline-none focus:border-primary focus-visible:shadow-none dark:border-form-strokedark dark:bg-form-input dark:text-white dark:focus:border-primary"
                                                type="password"
